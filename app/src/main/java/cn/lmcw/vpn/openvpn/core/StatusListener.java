...
import cn.lmcw.vpn.openvpn.core.IStatusCallbacks;
...
public class StatusListener {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            try {
                ...
                if (service.queryLocalInterface("cn.lmcw.vpn.openvpn.core.IServiceStatus") == null) {
                    // Not a local service
    ...
    public void init(Context c) {
        ...
        intent.setAction(cn.lmcw.vpn.openvpn.core.OpenVPNService.START_SERVICE);
