...
import cn.lmcw.vpn.BuildConfig;
...
import cn.lmcw.vpn.openvpn.core.VpnStatus.ByteCountListener;
import cn.lmcw.vpn.openvpn.core.VpnStatus.StateListener;
import cn.lmcw.vpn.openvpn.log.LogWindow;
import cn.lmcw.vpn.utils.Util;

import static cn.lmcw.vpn.openvpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static cn.lmcw.vpn.openvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static cn.lmcw.vpn.openvpn.core.NetworkSpace.ipAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "cn.lmcw.vpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "cn.lmcw.vpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "cn.lmcw.vpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "cn.lmcw.vpn.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "cn.lmcw.vpn.PAUSE_VPN";
    private static final String RESUME_VPN = "cn.lmcw.vpn.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, int priority, long when, ConnectionStatus status) {
        ...
        if (mProfile == null) {
            ...
            Toast.makeText(OpenVPNService.this, "pf is null", Toast.LENGTH_SHORT).show();
        }
        if (mProfile != null)
...
//        Class activityClass = null;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null) {
            Log.i("vvvvvvvv", "intent in null");
        }
        if (!intent.hasExtra(getPackageName() + ".profileUUID")) {
            Log.i("vvvvvvvv", "no hasExtra");
        }
        ...
        if (intent != null && intent.hasExtra(getPackageName() + ".profileUUID")) {
            ...
            mProfile = ProfileUtil.getUseConnectedProfile();
            if (mProfile == null) {
                Toast.makeText(OpenVPNService.this, "mProfile is null", Toast.LENGTH_SHORT).show();
            }
            ...
            if (mProfile == null) {
                Log.i("aaaaa", "Got no last connected profile on null intent. Assuming always on.");
                mProfile = ProfileUtil.getUseConnectedProfile();
                if (mProfile == null) {
                    stopSelf(startId);
                    return START_NOT_STICKY;
        ...
        //mProfile = (VpnProfile) Util.read(Util.getSDPath() + "/openvpn.conf");
        ...
        ProfileUtil.setUseConnectedProfile(mProfile);
    ...
    private void startOpenVPN() {
        ...
        Log.i("aaaaa", "startOpenVPN 启动VPN");
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("cn.lmcw.vpn.openvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("cn.lmcw.vpn.VPN_STATUS");
