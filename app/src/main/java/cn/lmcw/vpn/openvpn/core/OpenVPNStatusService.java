...
public class OpenVPNStatusService extends Service implements VpnStatus.LogListener, VpnStatus.ByteCountListener, VpnStatus.StateListener {
    ...
    public void onCreate() {
        ...
        Log.i("aaaaa", "OpenVPNStatusService onCreate");
    }
    ...
    public void onDestroy() {
        ...
        mCallbacks.kill();
        Log.i("aaaaa", "OpenVPNStatusService onDestroy");
    ...
    public void newLog(LogItem logItem) {
        ...
        //HermesEventBus.getDefault().postSticky(logItem);
...
//        byteConut = new ByteCount(in, out, diffIn, diffOut);
        //HermesEventBus.getDefault().postSticky(byteConut);
